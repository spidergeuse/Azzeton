...
namespace Azzeton.Shared
{
    public class MAPI
    {
        ...
        private enum HowTo{MAPI_ORIG=0, MAPI_TO, MAPI_CC, MAPI_BCC};
        ...
        private int SendMail(int how)
        {
            
            MapiMessage msg = new MapiMessage();
            msg.subject = this.Subject;
            msg.noteText = this.Message;
        ...
        {
            return SendMail(MAPI_LOGON_UI | MAPI_DIALOG);
        }
        public int SendMailDirect()
        {

            return SendMail(MAPI_LOGON_UI);
        }
